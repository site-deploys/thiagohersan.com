window.onload = function() {
  ...
  if(mUrl.endsWith(FOF_TOKEN)) {
    ...
    var contentElement = document.getElementById("project").getElementsByTagName("content")[0]
    contentElement.innerHTML = outputMessage;

    setTimeout(function() {
      window.location.href = "https://www.google.com.br/search?q=site%3Athiagohersan.com+"+pageName;
    }, 5555);
